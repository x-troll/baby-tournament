...
// anyone else hitting /playtimes/<slug> with baby intent (a token, or a
// session for a different playtime) but no valid session for *this*
// playtime sees, including an admin's own "Preview as baby" fallback for
// babies with no Telegram. No baby session exists at this point, so
// there's nobody's own /profile preference to read — this uses the
// deployment-wide term instead (see baby-terminology.ts).
//
